      ...
      <div className="mx-auto w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="mt-4 text-sm sm:text-base text-gray-600 dark:text-gray-300">
            {step === 'choice'
              ? isMigrationMode
                ? 'We detected existing data from an earlier Whiteboard version.'
                : 'This looks like a new Whiteboard setup.'
            ...
            <>
              ...
              {isMigrationMode && (
                <div className="mb-6 rounded-lg border border-blue-200 dark:border-blue-900 bg-blue-50 dark:bg-blue-900/20 p-4 text-sm text-blue-800 dark:text-blue-200">
                  Whiteboard v0.4 adds multi-user and OIDC support. Enabling authentication secures upgraded instances before sharing access.
                </div>
              )}
